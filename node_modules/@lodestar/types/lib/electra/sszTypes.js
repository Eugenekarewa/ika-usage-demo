...
const { Epoch, Gwei, UintNum64, Slot, Root, BLSSignature, UintBn256, Bytes32, BLSPubkey, DepositIndex, UintBn64, ExecutionAddress, ValidatorIndex, CommitteeIndex, } = primitiveSsz;
...
export const AttestingIndices = new ListBasicType(ValidatorIndex, MAX_VALIDATORS_PER_COMMITTEE * MAX_COMMITTEES_PER_SLOT);
...
export const ConsolidationRequests = new ListCompositeType(ConsolidationRequest, MAX_CONSOLIDATION_REQUESTS_PER_PAYLOAD);
...
export const PendingPartialWithdrawals = new ListCompositeType(PendingPartialWithdrawal, PENDING_PARTIAL_WITHDRAWALS_LIMIT);

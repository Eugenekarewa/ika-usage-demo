import { ContainerNodeStructType } from "@chainsafe/ssz";
...
export class ValidatorNodeStructType extends ContainerNodeStructType {
    ...
    value_serializeToBytes({ uint8Array: output, dataView }, offset, validator) {
...
function writeEpochInf(dataView, offset, value) {
    if (value === Infinity) {

...
import { EPOCHS_PER_SYNC_COMMITTEE_PERIOD, FINALIZED_ROOT_DEPTH, HISTORICAL_ROOTS_LIMIT, NEXT_SYNC_COMMITTEE_DEPTH, SLOTS_PER_EPOCH, SYNC_COMMITTEE_SIZE, SYNC_COMMITTEE_SUBNET_COUNT, VALIDATOR_REGISTRY_LIMIT, } from "@lodestar/params";
import * as phase0Ssz from "../phase0/sszTypes.js";
import * as primitiveSsz from "../primitive/sszTypes.js";
const { Bytes32, UintNum64, UintBn64, Slot, SubcommitteeIndex, ValidatorIndex, Root, BLSPubkey, BLSSignature, ParticipationFlags, } = primitiveSsz;

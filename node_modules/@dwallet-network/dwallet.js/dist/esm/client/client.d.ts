...
export declare const DWALLET_CLIENT_BRAND: unique symbol;
export declare function isDWalletClient(client: unknown): client is DWalletClient;
export declare class DWalletClient {
    protected transport: SuiTransport;
    get [DWALLET_CLIENT_BRAND](): boolean;
    /**

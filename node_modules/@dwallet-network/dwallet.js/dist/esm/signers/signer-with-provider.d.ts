...
import type { DevInspectResults, DryRunTransactionBlockResponse, DWalletClient, ExecuteTransactionRequestType, SuiTransactionBlockResponse, SuiTransactionBlockResponseOptions } from '../client/index.js';
...
export declare abstract class SignerWithProvider implements Signer {
     ...
     */
    devInspectTransactionBlock(input: Omit<Parameters<DWalletClient['devInspectTransactionBlock']>[0], 'sender'>): Promise<DevInspectResults>;
    /**

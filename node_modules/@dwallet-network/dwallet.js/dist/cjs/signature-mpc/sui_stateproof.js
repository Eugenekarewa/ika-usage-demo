...
var sui_stateproof_exports = {};
__export(sui_stateproof_exports, {
  submitDWalletCreationProof: () => submitDWalletCreationProof,
  submitTxStateProof: () => submitTxStateProof
});
module.exports = __toCommonJS(sui_stateproof_exports);
...
async function submitDWalletCreationProof(dwallet_client, sui_client, configObjectId, registryObjectId, dWalletCapId, txId, serviceUrl, keypair) {
  ...
  let txb = new import_builder.TransactionBlock();
...
async function queryTxData(txId, url) {
  ...
  try {
    const response = await import_axios.default.get(url, { params });

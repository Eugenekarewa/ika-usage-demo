...
__export(client_exports, {
  DWALLET_CLIENT_BRAND: () => DWALLET_CLIENT_BRAND,
  DWalletClient: () => DWalletClient,
  isDWalletClient: () => isDWalletClient
});
...
const DWALLET_CLIENT_BRAND = Symbol.for("@dwallet-network/SuiClient");
function isDWalletClient(client) {
  return typeof client === "object" && client !== null && client[DWALLET_CLIENT_BRAND] === true;
}
class DWalletClient {

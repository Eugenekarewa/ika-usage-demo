 ...
 * @returns {any}
 */
export function get_initial_state_bcs(checkpoint, rpc, network, bootstrap) {
    try {
 ...
 * @returns {any}
 */
export function get_current_period(state_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {boolean}
 */
export function try_verify_proof(proof, contract_address, message, dwallet_id, data_slot, state_root) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('eth_light_client_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

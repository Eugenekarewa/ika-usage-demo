 ...
 * @returns {any}
 */
module.exports.get_initial_state_bcs = function(checkpoint, rpc, network, bootstrap) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_initial_state_bcs(retptr, addHeapObject(checkpoint), addHeapObject(rpc), addHeapObject(network), addHeapObject(bootstrap));
 ...
 * @returns {any}
 */
module.exports.get_current_period = function(state_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_current_period(retptr, addHeapObject(state_bytes));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {boolean}
 */
module.exports.try_verify_proof = function(proof, contract_address, message, dwallet_id, data_slot, state_root) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.try_verify_proof(retptr, addHeapObject(proof), addHeapObject(contract_address), addHeapObject(message), addHeapObject(dwallet_id), addHeapObject(data_slot), addHeapObject(state_root));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
const path = require('path').join(__dirname, 'eth_light_client_wasm_bg.wasm');
